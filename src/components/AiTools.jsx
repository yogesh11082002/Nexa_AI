...
const AiTools = () => {
  ...
  const tools = [
    {
      ...
      gradient: "linear-gradient(rgb(53,136,242), rgb(11,176,215))",
      icon: (
        <>
          <path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
          <path d="M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z" />
    ...
    },
    {
      ...
      gradient: "linear-gradient(rgb(177,83,234), rgb(229,73,163))",
      icon: (
        <>
          <line x1="4" x2="20" y1="9" y2="9" />
          <line x1="4" x2="20" y1="15" y2="15" />
    ...
    },
    {
      ...
      gradient: "linear-gradient(rgb(32,195,99), rgb(17,185,126))",
      icon: (
        <>
          <rect width="18" height="18" x="3" y="3" rx="2" ry="2" />
          <circle cx="9" cy="9" r="2" />
    ...
    },
    {
      ...
      gradient: "linear-gradient(rgb(247,108,28), rgb(240,74,60))",
      icon: (
        <>
          <path d="M21 21H8a2 2 0 0 1-1.42-.587l-3.994-3.999a2 2 0 0 1 0-2.828l10-10a2 2 0 0 1 2.829 0l5.999 6a2 2 0 0 1 0 2.828L12.834 21" />
          <path d="m5.082 11.09 8.828 8.828" />
    ...
    },
    {
      ...
      gradient: "linear-gradient(rgb(92,106,241), rgb(66,125,245))",
      icon: (
        <>
          <circle cx="6" cy="6" r="3" />
          <path d="M8.12 8.12 12 12" />
    ...
    },
    {
      ...
      gradient: "linear-gradient(rgb(18,183,172), rgb(8,182,206))",
      icon: (
        <>
          <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" />
          <path d="M14 2v4a2 2 0 0 0 2 2h4" />
  ...
  return (
    <div ref={sectionRef}>
      <div className="px-4 sm:px-20 xl:px-32 my-24 mt-5">
        <div className="text-center">
          <h2 className="text-slate-700 text-[42px] font-semibold">
            Powerful AI Tools
          </h2>
        ...
        <div className="flex flex-wrap mt-10 justify-center">
          {tools.map((tool, index) => (
            <motion.div
              key={index}
              className="tool-card p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 cursor-pointer"
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide w-12 h-12 p-3 text-white rounded-xl"
